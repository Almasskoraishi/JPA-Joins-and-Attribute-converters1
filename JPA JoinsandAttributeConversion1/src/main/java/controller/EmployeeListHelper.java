...
public class EmployeeListHelper {
	...
	public void deleteEmpployee(EmployeeList toDelete) {
		...
		TypedQuery<EmployeeList> typedQuery = em.createQuery(
				"select el from EmployeeList el where el.empFirstName = :selectedEmpFirstName and el.EmpLastName = :selectedEmpLastName",
				EmployeeList.class);
	...
	public List<EmployeeList> searchForEmpFirstNameByEmpFirstName(String empFirstName) {
		...
		em.getTransaction().begin();
		TypedQuery<EmployeeList> typedQuery = em.createQuery(
				"select el from EmployeeList el where el.empFirstName = :selectedEmpFirstName", EmployeeList.class);
	...
	public List<EmployeeList> searchForEmpLastNameByEmpLastName(String EmpLastName) {
		...
		em.getTransaction().begin();
		TypedQuery<EmployeeList> typedQuery = em.createQuery(
				"select el from EmployeeList el where el.empLastName = :selectedEmpLastName", EmployeeList.class);
